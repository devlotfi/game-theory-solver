...
function RouteComponent() {
  const { player1Strategies, player2Strategies, gainsTable } =
      ...
      <table className="border-separate border-spacing-[0.5rem] inline-block m-auto">
        <tbody>
          <tr>
            ...
            <td>
              <div className="flex">
                <AddStrategyBtn player={Players.PLAYER_2}></AddStrategyBtn>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td>
              <div className="flex justify-center">
                <AddStrategyBtn player={Players.PLAYER_1}></AddStrategyBtn>
              </div>
            </td>
          </tr>
        </tbody>
